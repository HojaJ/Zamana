            ...
            <form action="{{route('admin.suggest.update', $suggest->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <textarea id="content_tk" class="form-control textarea_summer" rows="3" name="content_tk">{{ $suggest->content_tk }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <textarea id="content_ru" class="form-control textarea_summer" rows="3" name="content_ru">{{ $suggest->content_ru }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <textarea id="content_en" class="form-control textarea_summer" rows="3" name="content_en">{{ $suggest->content_en }}</textarea>
                    </div>
                </div>
