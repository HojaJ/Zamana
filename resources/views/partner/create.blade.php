            ...
            <form action="{{route('admin.partner.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <textarea id="testimonial_tk" class="form-control" rows="3" name="testimonial_tk"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <textarea id="testimonial_ru" class="form-control" rows="3" name="testimonial_ru"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <textarea id="testimonial_en" class="form-control" rows="3" name="testimonial_en"></textarea>
                    </div>
                </div>
